...
:exclamation: You may need to manually download `HSI_TeSet.mat` and `HSI_TrSet.mat` in MDL-RS_CNNs file to your local in the folder under path `IEEE_TGRS_MDL-RS/MDL-RS_CNNs/HSI_LiDAR_CNN/`, due to their too large file size.
