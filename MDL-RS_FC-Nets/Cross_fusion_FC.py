...
def mynetwork(x1, x2, parameters, isTraining, momentums = 0.9):

    with tf.name_scope("encoder_layer_1"):
        
         x1_encoder_layer_z1 = tf.matmul(x1, parameters['x1_encoder_h1']) + parameters['x1_encoder_b1']                                       
         x1_encoder_layer_z1_bn = tf.layers.batch_normalization(x1_encoder_layer_z1, momentum = momentums, training = isTraining) 
         ...
         x2_encoder_layer_z1_bn = tf.layers.batch_normalization(x2_encoder_layer_z1, momentum = momentums, training = isTraining)
    ...
    with tf.name_scope("encoder_layer_2"):
         ...
         x1_encoder_layer_z2_bn = tf.layers.batch_normalization(x1_encoder_layer_z2, momentum = momentums, training = isTraining)                                                     
         ...
         x2_encoder_layer_z2_bn = tf.layers.batch_normalization(x2_encoder_layer_z2, momentum = momentums, training = isTraining)                                                          
    ...
    with tf.name_scope("encoder_layer_3"):
         ...
         x1_encoder_layer_z3_bn = tf.layers.batch_normalization(x1_encoder_layer_z3, momentum = momentums, training = isTraining)
         ...
         x2_encoder_layer_z3_bn = tf.layers.batch_normalization(x2_encoder_layer_z3, momentum = momentums, training = isTraining)                                                        
    ...
    with tf.name_scope("encoder_layer_4"):
         ...
         x1_encoder_layer_z4_bn = tf.layers.batch_normalization(x1_encoder_layer_z4, momentum = momentums, training = isTraining)                                             
         ...
         x2_encoder_layer_z4_bn = tf.layers.batch_normalization(x2_encoder_layer_z4, momentum = momentums, training = isTraining)                                                        
         x2_encoder_layer_a4 = tf.nn.relu(x2_encoder_layer_z4_bn)

         x12_encoder_layer_z4 = tf.matmul(x2_encoder_layer_a3, parameters['x1_encoder_h4']) + parameters['x1_encoder_b4']
         x12_encoder_layer_z4_bn = tf.layers.batch_normalization(x12_encoder_layer_z4, momentum = momentums, training = isTraining)    
         x12_encoder_layer_a4 = tf.nn.relu(x12_encoder_layer_z4_bn)
         
         x21_encoder_layer_z4 = tf.matmul(x1_encoder_layer_a3, parameters['x2_encoder_h4']) + parameters['x2_encoder_b4']
         x21_encoder_layer_z4_bn = tf.layers.batch_normalization(x21_encoder_layer_z4, momentum = momentums, training = isTraining)                                                
         x21_encoder_layer_a4 = tf.nn.relu(x21_encoder_layer_z4_bn)
         
         joint_encoder_layer1 = tf.concat([x1_encoder_layer_a4 + x12_encoder_layer_a4, x2_encoder_layer_a4 + x21_encoder_layer_a4], 1)
         joint_encoder_layer2 = tf.concat([x1_encoder_layer_a4, x21_encoder_layer_a4], 1)
         joint_encoder_layer3 = tf.concat([x12_encoder_layer_a4, x2_encoder_layer_a4], 1)
   
    with tf.name_scope("fusion_layer"):
         
         fusion1_layer_z1 = tf.matmul(joint_encoder_layer1, parameters['joint_encoder_h1']) + parameters['joint_encoder_b1']
         fusion1_layer_z1_bn = tf.layers.batch_normalization(fusion1_layer_z1, momentum = momentums, training = isTraining)                                              
         fusion1_layer_a1 = tf.nn.relu(fusion1_layer_z1_bn)

         fusion2_layer_z1 = tf.matmul(joint_encoder_layer2, parameters['joint_encoder_h1']) + parameters['joint_encoder_b1']
         fusion2_layer_z1_bn = tf.layers.batch_normalization(fusion2_layer_z1, momentum = momentums, training = isTraining)                                             
         fusion2_layer_a1 = tf.nn.relu(fusion2_layer_z1_bn)
      
         fusion3_layer_z1 = tf.matmul(joint_encoder_layer3, parameters['joint_encoder_h1']) + parameters['joint_encoder_b1']
         fusion3_layer_z1_bn = tf.layers.batch_normalization(fusion3_layer_z1, momentum = momentums, training = isTraining)                                              
         fusion3_layer_a1 = tf.nn.relu(fusion3_layer_z1_bn)
          
         fusion1_layer_z2 = tf.matmul(fusion1_layer_a1, parameters['joint_encoder_h2']) + parameters['joint_encoder_b2']
         fusion1_layer_z2_bn = tf.layers.batch_normalization(fusion1_layer_z2, momentum = momentums, training = isTraining) 
         fusion1_layer_a2 = tf.nn.relu(fusion1_layer_z2_bn)

         fusion2_layer_z2 = tf.matmul(fusion2_layer_a1, parameters['joint_encoder_h2']) + parameters['joint_encoder_b2']
         fusion2_layer_z2_bn = tf.layers.batch_normalization(fusion2_layer_z2, momentum = momentums, training = isTraining) 
         fusion2_layer_a2 = tf.nn.relu(fusion2_layer_z2_bn)

         fusion3_layer_z2 = tf.matmul(fusion3_layer_a1, parameters['joint_encoder_h2']) + parameters['joint_encoder_b2']
         fusion3_layer_z2_bn = tf.layers.batch_normalization(fusion3_layer_z2, momentum = momentums, training = isTraining) 
         fusion3_layer_a2 = tf.nn.relu(fusion3_layer_z2_bn)

         joint1_encoder_layer_z3 = tf.matmul(fusion1_layer_a2, parameters['joint_encoder_h3']) + parameters['joint_encoder_b3']
         joint2_encoder_layer_z3 = tf.matmul(fusion2_layer_a2, parameters['joint_encoder_h3']) + parameters['joint_encoder_b3']
         joint3_encoder_layer_z3 = tf.matmul(fusion3_layer_a2, parameters['joint_encoder_h3']) + parameters['joint_encoder_b3'] 
    ...
    l2_loss =   tf.nn.l2_loss(parameters['joint_encoder_h2']) + tf.nn.l2_loss(parameters['joint_encoder_h1']) + tf.nn.l2_loss(parameters['joint_encoder_h3'])\
                ...
                + tf.nn.l2_loss(parameters['x1_encoder_h3']) + tf.nn.l2_loss(parameters['x2_encoder_h3']) + tf.nn.l2_loss(parameters['x1_encoder_h4']) + tf.nn.l2_loss(parameters['x2_encoder_h4'])
      
    return joint1_encoder_layer_z3, joint2_encoder_layer_z3, joint3_encoder_layer_z3, l2_loss
...
def train_mynetwork(x1_train_set, x2_train_set, x1_test_set, x2_test_set, y_train_set, y_test_set, MODEL,
    ...
    with tf.Session() as sess:
        ...
        print("save model")
        save_path = saver.save(sess,"D:\Python_Project\MDL-RS/save_Cross_FC/model.ckpt")
